...
## Corpus Check
- 144 files · ~57,969 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 791 nodes · 1874 edges · 63 communities (34 shown, 23 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0c18ba13`
...
Cohesion: 0.27
Nodes (12): getAdminClient(), POST(), VALID_ROLES, getAdminClient(), POST(), VALID_ROLES, getAdminClient(), POST() (+4 more)
...
Cohesion: 0.10
Nodes (49): EditProfileDialog(), handleSubmit(), CadastrosPage(), Filtro, AddEnderecoForm(), EditEnderecoForm(), EntregaResumo, OrdemEntregas (+41 more)
...
Cohesion: 0.06
Nodes (45): createUser(), updateProfile(), addEndereco(), createCliente(), createClienteMultiEnderecos(), deleteEndereco(), geocodeExistingAddresses(), updateCliente() (+37 more)
