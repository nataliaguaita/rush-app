-- Quem cancelou a entrega (botão "Excluir Entrega"). NULL em canceladas antes desta coluna.
ALTER TABLE entregas ADD COLUMN IF NOT EXISTS cancelado_por UUID REFERENCES profiles(id);

-- Entregador não pode preencher quem cancelou.
